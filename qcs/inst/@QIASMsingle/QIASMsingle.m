...
## -*- texinfo -*-
## @deftypefn {Function File} {@var{C} =} QASMsingle (@var{n},@var{t},@var{p})
##
## Construct single qubit gate @var{n} with target qubit @var{t} and
## parameters @var{p}.
...
function g = QIASMsingle(name,tar,params=[])
