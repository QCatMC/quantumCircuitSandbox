...
## Usage: C = buildQIASMcircuit(args)
##
## Used to construct a QIASM quantum circuit object from a circuit descriptor. 
## 
...
function C = buildQIASMcircuit( varargin )
